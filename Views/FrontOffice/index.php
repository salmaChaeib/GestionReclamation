...
<html>
<head>
<title>Be Free votre site web de voyage :: w3layouts</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="BeFree Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
      ...
      <div class="header-grid">
        ...
        <div class="header-left animated wow fadeInLeft" data-wow-delay=".5s">
          <ul>
            ...
            <li><i class="glyphicon glyphicon-envelope" ></i><a href="Befree@gmail.com">@Befree@gmail.com</a></li>
            <li><i class="glyphicon glyphicon-earphone" ></i>+216 99.000.000
          </ul>
        </div>
          ...
          <div class="navbar-header nav_2">
            <button type="button" class="navbar-toggle collapsed navbar-toggle1" data-toggle="collapse" data-target="#bs-megadropdown-tabs">
             ...
             <div class="navbar-brand logo-nav-left wow fadeInLeft animated" data-wow-delay=".5s">
              <h1 class="animated wow pulse" data-wow-delay=".5s"><a href="index.html">Be Free<span>vous accueille</span></a></h1>
            </div>
...
<div class="banner-top">
  <div class="container">
    <h2 class="animated wow fadeInLeft" data-wow-delay=".5s">réclamation</h2>
    <!--
  ...
  <!--content-->
   <div class="container">
          <h2 class="title">Be Free est là pour vous êcouter !</h2>

          <div id="inputs">
      
            <p class="category">Saisir votre réclamation</p>
            <div class="col-md-6">
           ...
           <button class="btn btn-danger" type ="reset">annuler </button>
                ...
                <a href='consulterRecHost.php' class='btn btn-premiere'>consulter mes reclamations</a>
...
<!-- footer -->
  <div class="footer">
    ...
    <h4>Qui est Befree? </h4>
    <p>Be Free est un site web consacré aux passionnés de voyage et de découverte. Un site qui vous mettra plein les yeux au niveau de la qualité du service ainsi il vous fera rêvez </p>
    </div>
    ...
    <div class="clearfix"> </div>
      ...
      <div class="footer-grids">
        <div class="col-md-4 footer-grid animated wow fadeInLeft" data-wow-delay=".5s"> 
          <h3>BE Free</h3>
          <p> Réveiller l'âme d'aventurier qui est en vous ! 
            <span>N'hésitez pas à nous contacter, on sera à votre disponibilité 24h/24 et 7j/7 .</span></p>
        </div>
        <div class="col-md-4 footer-grid animated wow fadeInLeft" data-wow-delay=".6s">
          <h3>Contact Info</h3>
          <ul>
            <li><i class="glyphicon glyphicon-map-marker" ></i> Avenue de la republique 43 ,  <span>Rades.</span></li>
            <li class="foot-mid"><i class="glyphicon glyphicon-envelope" ></i><a href="mailto:befree@gmail.com">Befree@gmail.com</a></li>
            <li><i class="glyphicon glyphicon-earphone" ></i>+216 99.000.000</li>
          </ul>
        </div>
