            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Creer Reclamation</h2>
                    </div>
                   
                    <form action="CreateReclamation.php" method="post">
        <label for="id">ID</label>
      
        <input type="text" name="id" placeholder="26"  id="id">
        <label for="titre">titre</label>
        <input type="text" name="titre" placeholder="John Doe" id="titre">
        <label for="description">Description</label>
        <input type="text" name="description" placeholder="26"  id="description">
        <label for="role">role</label>
        <input type="text" name="role" placeholder="26"  id="role">
