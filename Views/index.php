            ...
            <form action="index.php" method="post">
              <div >
                <div class="form-group has-successform-group has-success">
                  <input type="text"  name="titre" placeholder="titre reclamation" class="form-control" />
                </div>
              </div>
              <div >
                <div class="form-group has-success">
                  <input type="text" name="description" placeholder="description reclamation" class="form-control form-control-success" />
                </div>
              </div>
              <div >
                <div class="form-group has-success">
                  <input type="texte"  name="role" placeholder="gest / host"  class="form-control form-control-danger" />
                </div>
              </div>
              ...
              <div >
                <div class="input-group">
                  ...
                  <input type="datetime-local" name="created"  value="<?=date('Y-m-d\TH:i')?>"  class="form-control" placeholder="Left Font Awesome Icon">
                </div>
              </div>
